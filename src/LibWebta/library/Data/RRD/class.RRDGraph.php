<?
	...
	class RRDGraph extends Core
	{
		 ...
		 * @var string
		 */
		private $RRDToolPath = "/usr/bin/rrdtool";
		 ...
		 */
		function __construct($width, $height, $path_to_rrdtool = false)
		{
			$this->Width = $width;
			$this->Height = $height;
			...
			if ($path_to_rrdtool)
				$this->RRDToolPath = $path_to_rrdtool; 
			...
			switch($method)
			{
				...
				*/
				case "GPrint":
						...
						array_push($this->Args, "GPRINT:{$args['0']}:{$args['1']}");
