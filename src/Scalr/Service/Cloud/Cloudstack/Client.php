...
class Scalr_Service_Cloud_Cloudstack_Client extends Scalr_Service_Cloud_Cloudstack_Connection {
    ...
    */
    ...
    public function deployVirtualMachine($serviceOfferingId, $templateId, $zoneId, $account = "", $diskOfferingId = "", $displayName = "", $domainId = "", $group = "", $hostId = "", $hypervisor = "", $keyPair = "", $name = "", $networkIds = "", $securityGroupIds = "", $securityGroupNames = "", $size = "", $userData = "") {
        ...
        if (empty($serviceOfferingId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "serviceOfferingId"), MISSING_ARGUMENT);
        }

        if (empty($templateId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "templateId"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function destroyVirtualMachine($id) {
        ...
        if (empty($id)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "id"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function createTemplate($displayText, $name, $osTypeId, $bits = "", $isFeatured = "", $isPublic = "", $passwordEnabled = "", $requireShvm = "", $snapshotId = "", $volumeId = "") {
        ...
        if (empty($displayText)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "displayText"), MISSING_ARGUMENT);
        }

        if (empty($name)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "name"), MISSING_ARGUMENT);
        }

        if (empty($osTypeId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "osTypeId"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function registerTemplate($displayText, $format, $hypervisor, $name, $osTypeId, $url, $zoneId, $account = "", $bits = "", $checksum = "", $domainId = "", $isExtractable = "", $isFeatured = "", $isPublic = "", $passwordEnabled = "", $requireShvm = "") {
        ...
        if (empty($format)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "format"), MISSING_ARGUMENT);
        }

        if (empty($hypervisor)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "hypervisor"), MISSING_ARGUMENT);
        }
        ...
        if (empty($url)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "url"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function copyTemplate($id, $destzoneId, $sourceZoneId) {
        ...
        if (empty($destzoneId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "destzoneId"), MISSING_ARGUMENT);
        }

        if (empty($sourceZoneId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "sourceZoneId"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function listTemplates($templateFilter, $account = "", $domainId = "", $hypervisor = "", $id = "", $keyword = "", $name = "", $page = "", $pageSize = "", $zoneId = "", $page = "") {
        ...
        if (empty($templateFilter)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "templateFilter"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function extractTemplate($id, $mode, $zoneId, $url = "") {
        ...
        if (empty($mode)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "mode"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function attachIso($id, $virtualMachineId) {
        ...
        if (empty($virtualMachineId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "virtualMachineId"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function createSnapshot($volumeId, $account = "", $domainId = "", $policyId = "") {
        ...
        if (empty($volumeId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "volumeId"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function createSnapshotPolicy($intervalType, $maxSnaps, $schedule, $timezone, $volumeId) {
        ...
        if (empty($intervalType)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "intervalType"), MISSING_ARGUMENT);
        }

        if (empty($maxSnaps)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "maxSnaps"), MISSING_ARGUMENT);
        }

        if (empty($schedule)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "schedule"), MISSING_ARGUMENT);
        }

        if (empty($timezone)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "timezone"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function queryAsyncJobResult($jobId) {
        ...
        if (empty($jobId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "jobId"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function createRemoteAccessVpn($publicIpId, $account = "", $domainId = "", $ipRange = "") {
        ...
        if (empty($publicIpId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "publicIpId"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function addVpnUser($password, $userName, $account = "", $domainId = "") {
        ...
        if (empty($password)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "password"), MISSING_ARGUMENT);
        }

        if (empty($userName)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "userName"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function createPortForwardingRule($ipAddressId, $privatePort, $protocol, $publicPort, $virtualMachineId) {
        ...
        if (empty($ipAddressId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "ipAddressId"), MISSING_ARGUMENT);
        }

        if (empty($privatePort)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "privatePort"), MISSING_ARGUMENT);
        }

        if (empty($protocol)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "protocol"), MISSING_ARGUMENT);
        }

        if (empty($publicPort)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "publicPort"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function createIpForwardingRule($ipAddressId, $protocol, $startPort, $endPort = "") {
        ...
        if (empty($startPort)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "startPort"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function createLoadBalancerRule($algorithm, $name, $privatePort, $publicIpId, $publicPort, $description = "") {
        ...
        if (empty($algorithm)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "algorithm"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function removeFromLoadBalancerRule($id, $virtualMachineIds) {
        ...
        if (empty($virtualMachineIds)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "virtualMachineIds"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function registerSSHKeyPair($name, $publicKey) {
        ...
        if (empty($publicKey)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "publicKey"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function createNetwork($displayText, $name, $networkOfferingId, $zoneId, $account = "", $domainId = "", $endIp = "", $gateway = "", $isDefault = "", $isShared = "", $netmask = "", $networkDomain = "", $startIp = "", $vlan = "") {
        ...
        if (empty($networkOfferingId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "networkOfferingId"), MISSING_ARGUMENT);
        }
    ...
    */
    ...
    public function getCloudIdentifier($userId) {
        ...
        if (empty($userId)) {
            throw new Scalr_Service_Cloud_Cloudstack_Exception(sprintf(MISSING_ARGUMENT_MSG, "userId"), MISSING_ARGUMENT);
        }
